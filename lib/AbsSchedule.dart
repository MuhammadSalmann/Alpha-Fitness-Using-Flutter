        ...
        child: Column(
            ...
            children: [
              Container(
                  ...
                  child: TextButton(
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>abshistory()));
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Leg Raises',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          //                         fontSize: 20
                                          //                     ),
                                          //                     controller: legraisesweightController,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: legraisessetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: legraisesrepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(legraisessetsController.text.toString().isEmpty || legraisesrepsController.text.toString().isEmpty  ){
                                                ...
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Leg Raises sets': legraisessetsController
                                                      .text.toString(),
                                                  'Leg Raises reps': legraisesrepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Crunches Frog',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          //                         fontSize: 20
                                          //                     ),
                                          //                     controller: crunchesweightController,
                                          //                     decoration: InputDecoration(
                                          //                         enabledBorder: OutlineInputBorder(
                                          //                             borderSide: BorderSide(
                                          //                               color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller:crunchessetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: crunchesrepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if( crunchessetsController.text.toString().isEmpty || crunchesrepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Frog Crunches sets': crunchessetsController
                                                      .text.toString(),
                                                  'Frog Crunches reps': crunchesrepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Bicycle Crunches',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          //                         fontSize: 20
                                          //                     ),
                                          //                     controller: bicycleweightController,
                                          //                     decoration: InputDecoration(
                                          //                         enabledBorder: OutlineInputBorder(
                                          //                             borderSide: BorderSide(
                                          //                               color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: bicyclesetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: bicyclerepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if( bicyclesetsController.text.toString().isEmpty || bicyclerepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Bicycle Crunches sets': bicyclesetsController
                                                      .text.toString(),
                                                  'Bicycle Crunches reps': bicyclerepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
