          ...
          children: [
            Container(
              child: Text(
                ...
                'CHOOSE',style: TextStyle(color: Colors.red,fontFamily: "BebasNeue",letterSpacing: 1.5,fontSize: 27),),
            ),
            SizedBox(
              width: 8,
            ),
            Text('WORKOUT',style: TextStyle(color: Colors.white,fontFamily: "BebasNeue",letterSpacing: 1.5,fontSize: 27),),
          ],
        ),
      ),
