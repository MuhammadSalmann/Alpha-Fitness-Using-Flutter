...
void main() => runApp(const seatedcurl());

class seatedcurl extends StatelessWidget {
  const seatedcurl({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: seatedcurlscreen(),
    );
  }
}

class seatedcurlscreen extends StatefulWidget {
  const seatedcurlscreen({super.key});

  @override
  State<seatedcurlscreen> createState() => _seatedcurlscreenState();
}
class _seatedcurlscreenState extends State<seatedcurlscreen> {
...
'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684682416/vecteezy_barbell-seated-concentration-biceps-curl-fitness-exercise_23405604_437_m8svew.mp4',
    );
        ...
        child:Column(
          ...
          children:[
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
'Sit on a bench holding a barbell with your palms up and your hands shoulder width apart. Place your elbows inside your knees and your upper arms on your inner thighs. Contract your biceps to curl the weight towards your shoulders, squeeze at the top, then slowly lower.',
                style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('Biceps',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Forearms',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Triceps',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
