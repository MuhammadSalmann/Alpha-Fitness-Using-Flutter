        ...
        child: Column(
            ...
            children: [
              Container(
                  ...
                  child: TextButton(
                      onPressed: (){
                       Navigator.push(context, MaterialPageRoute(builder: (context)=>shoulderhistory()));
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Shoulder Side Raises',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Center(
                                                            child: TextField(
                                                              ...
                                                              controller: sideraiseweightController,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: sideraisesetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: sideraiserepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(sideraiseweightController.text.toString().isEmpty || sideraisesetsController.text.toString().isEmpty || sideraiserepsController.text.toString().isEmpty  ){
                                                ...
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Side Raises weights': sideraiseweightController
                                                      .text.toString(),
                                                  'Side Raises sets': sideraisesetsController
                                                      .text.toString(),
                                                  'Side Raises reps': sideraiserepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Shoulder Front Raises',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Center(
                                                            child: TextField(
                                                              ...
                                                              controller: frontraiseweightController,
                                                              decoration: InputDecoration(
                                                                  enabledBorder: OutlineInputBorder(
                                                                      borderSide: BorderSide(
                                                                        color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller:frontraisesetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: frontraiserepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(frontraiseweightController.text.toString().isEmpty || frontraisesetsController.text.toString().isEmpty || frontraiserepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Front Raises weights': frontraiseweightController
                                                      .text.toString(),
                                                  'Front Raises sets': frontraisesetsController
                                                      .text.toString(),
                                                  'Front Raises reps': frontraiserepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Shoulder Press',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Center(
                                                            child: TextField(
                                                              ...
                                                              controller: shoulderpressweightController,
                                                              decoration: InputDecoration(
                                                                  enabledBorder: OutlineInputBorder(
                                                                      borderSide: BorderSide(
                                                                        color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: shoulderpresssetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: shoulderpressrepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(shoulderpressweightController.text.toString().isEmpty || shoulderpresssetsController.text.toString().isEmpty || shoulderpressrepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Soulder Press weights': shoulderpressweightController
                                                      .text.toString(),
                                                  'Shoulder Press sets': shoulderpresssetsController
                                                      .text.toString(),
                                                  'Shoulder Press reps': shoulderpressrepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Reverse Fly',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Center(
                                                            child: TextField(
                                                              ...
                                                              controller: reverseflyweightController,
                                                              decoration: InputDecoration(
                                                                  enabledBorder: OutlineInputBorder(
                                                                      borderSide: BorderSide(
                                                                        color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: reverseflysetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: reverseflyrepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(reverseflyweightController.text.toString().isEmpty || reverseflysetsController.text.toString().isEmpty || reverseflyrepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Reverse Fly weights': reverseflyweightController
                                                      .text.toString(),
                                                  'Reverse Fly sets': reverseflysetsController
                                                      .text.toString(),
                                                  'Reverse Fly reps': reverseflyrepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
                ...
                child: Column(
                    children: [
                      Row(
                        children: [
                          Container(
                            child: Text('Upright Row',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                            margin: EdgeInsets.only(left: getwidth(context)*0.05),),
                          Spacer(),
                          Container(
                            child: CircleAvatar(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Center(
                                                            child: TextField(
                                                              ...
                                                              controller: uprightrowweightController,
                                                              decoration: InputDecoration(
                                                                  enabledBorder: OutlineInputBorder(
                                                                      borderSide: BorderSide(
                                                                        color: Colors.white,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Center(
                                                          child: TextField(
                                                            ...
                                                            controller: uprightrowsetsController,
                                                            decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                    borderSide: BorderSide(
                                                                      color: Colors.white,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Center(
                                                                child: TextField(
                                                                  ...
                                                                  controller: uprightrowrepsController,
                                                                  decoration: InputDecoration(
                                                                      enabledBorder: OutlineInputBorder(
                                                                          borderSide: BorderSide(
                                                                            color: Colors.white,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(uprightrowweightController.text.toString().isEmpty || uprightrowsetsController.text.toString().isEmpty || uprightrowrepsController.text.toString().isEmpty  ){
                                                toast('All Fields are required');
                                              }
                                              else {
                                                ref.child(
                                                    UserRecords().Userid
                                                        .toString())
                                                    .update({
                                                  'Upright weights': uprightrowweightController
                                                      .text.toString(),
                                                  'Upright sets': uprightrowsetsController
                                                      .text.toString(),
                                                  'Upright reps': uprightrowrepsController
                                                      .text.toString(),
                                                })
                                                    .then((value) {
                                                  toast('Workout Tracked');
