...
class shoulderhistory extends StatefulWidget {
  const shoulderhistory({Key? key}) : super(key: key);

  @override
  State<shoulderhistory> createState() => _shoulderhistoryState();
}

class _shoulderhistoryState extends State<shoulderhistory> {
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        ...
                        child: Text('Shoulder Side Raises',style: TextStyle(
                            fontSize: 21,
                              ...
                              FirebaseAnimatedList(
                                ...
                                itemBuilder: (context, snapshot, animation,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.child('Side Raises weights').value.toString(),
                            ...
                            FirebaseAnimatedList(
                              ...
                              itemBuilder: (context, snapshot, animation,
                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child:Text(
                                      snapshot.child('Side Raises sets').value.toString(),
                                      style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                );
                                  ...
                                  FirebaseAnimatedList(
                                    ...
                                    itemBuilder: (context, snapshot, animation,
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            snapshot.child('Side Raises reps').value.toString(),
                                            style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        margin: EdgeInsets.only(top: getheight(context)*0.02,left: getwidth(context)*0.04),
                        child: Text('Shoulder Front Raises',style: TextStyle(
                            fontSize: 21,
                            color: Colors.white,fontWeight: FontWeight.bold),)),
                    SizedBox(height: getheight(context)*0.02,),
                    Container(
                              ...
                              FirebaseAnimatedList(
                                ...
                                itemBuilder: (context, snapshot, animation,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.child('Front Raises weights').value.toString(),
                                        style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                  );
                            ...
                            FirebaseAnimatedList(
                              ...
                              itemBuilder: (context, snapshot, animation,
                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child:Text(
                                      snapshot.child('Front Raises sets').value.toString(),
                                      style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                );
                                  ...
                                  FirebaseAnimatedList(
                                    ...
                                    itemBuilder: (context, snapshot, animation,
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            snapshot.child('Front Raises reps').value.toString(),
                                            style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        margin: EdgeInsets.only(top: getheight(context)*0.02,left: getwidth(context)*0.04),
                        child: Text('Shoulder Press',style: TextStyle(
                            fontSize: 21,
                            color: Colors.white,fontWeight: FontWeight.bold),)),
                    SizedBox(height: getheight(context)*0.02,),
                    Container(
                              ...
                              FirebaseAnimatedList(
                                ...
                                itemBuilder: (context, snapshot, animation,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.child('Soulder Press weights').value.toString(),
                                        style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                  );
                            ...
                            FirebaseAnimatedList(
                              ...
                              itemBuilder: (context, snapshot, animation,
                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child:Text(
                                      snapshot.child('Shoulder Press sets').value.toString(),
                                      style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                );
                                  ...
                                  FirebaseAnimatedList(
                                    ...
                                    itemBuilder: (context, snapshot, animation,
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            snapshot.child('Shoulder Press reps').value.toString(),
                                            style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        margin: EdgeInsets.only(top: getheight(context)*0.02,left: getwidth(context)*0.04),
                        child: Text('Reverse Fly',style: TextStyle(
                            fontSize: 21,
                            color: Colors.white,fontWeight: FontWeight.bold),)),
                    SizedBox(height: getheight(context)*0.02,),
                    Container(
                              ...
                              FirebaseAnimatedList(
                                ...
                                itemBuilder: (context, snapshot, animation,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.child('Reverse Fly weights').value.toString(),
                                        style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                  );
                            ...
                            FirebaseAnimatedList(
                              ...
                              itemBuilder: (context, snapshot, animation,
                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child:Text(
                                      snapshot.child('Reverse Fly sets').value.toString(),
                                      style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                );
                                  ...
                                  FirebaseAnimatedList(
                                    ...
                                    itemBuilder: (context, snapshot, animation,
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            snapshot.child('Reverse Fly reps').value.toString(),
                                            style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      );
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        margin: EdgeInsets.only(top: getheight(context)*0.02,left: getwidth(context)*0.04),
                        child: Text('Upright Row',style: TextStyle(
                            fontSize: 21,
                            color: Colors.white,fontWeight: FontWeight.bold),)),
                    SizedBox(height: getheight(context)*0.02,),
                    Container(
                              ...
                              FirebaseAnimatedList(
                                ...
                                itemBuilder: (context, snapshot, animation,
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.child('Upright weights').value.toString(),
                                        style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                  );
                            ...
                            FirebaseAnimatedList(
                              ...
                              itemBuilder: (context, snapshot, animation,
                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child:Text(
                                      snapshot.child('Upright sets').value.toString(),
                                      style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                );
                                  ...
                                  FirebaseAnimatedList(
                                    ...
                                    itemBuilder: (context, snapshot, animation,
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            snapshot.child('Upright reps').value.toString(),
                                            style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                      );
