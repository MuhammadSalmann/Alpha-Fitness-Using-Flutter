...
import 'ArticleCalis.dart';
import 'ArticleVeggs.dart';
...
class _homescreenState extends State<homescreen> {
  ...
  List imagelist=[
    {"id":1,"imagepath":"assets/images/v.jpg"},
    {"id":1,"imagepath":"assets/images/eggg.jpg"},
    {"id":1,"imagepath":"assets/images/almond.jpg"},
    {"id":1,"imagepath":"assets/images/ca.jpg"},

  ];
  final CarouselController cController=new CarouselController();
...
onTap: (){
  if(currentIndex==0){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>articlevegg()));
  }
  else if(currentIndex==1){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>articleeggs()));
  }
  else if(currentIndex==2){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>articlealmonds()));
  }
  else if(currentIndex==3){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>articlecalis()));
  }
},
                    child: CarouselSlider(
                      items: [
                        Container(
                          margin: EdgeInsets.only(left: getwidth(context)*0.045,right: getwidth(context)*0.045),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
                            image: DecorationImage(
                              image:  AssetImage("assets/images/newveg.jpg"),
                              fit: BoxFit.cover,
                            )
                          ),
                        ),                      // child: Image.asset("assets/images/newveg.jpg",fit: BoxFit.cover,)),
                        Container(
                          margin: EdgeInsets.only(left: getwidth(context)*0.045,right: getwidth(context)*0.045),
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              image: DecorationImage(
                                image:  AssetImage("assets/images/neweggs.jpg"),
                                fit: BoxFit.cover,
                              )
                          ),
                        ),
                        Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              image: DecorationImage(
                                image:  AssetImage("assets/images/newalmond.jpg"),
                                fit: BoxFit.cover,
                              )
                          ),
                        ),
                        Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              image: DecorationImage(
                                image:  AssetImage("assets/images/newcalis.jpg"),
                                fit: BoxFit.cover,
                              )
                          ),
                        ),
